...
import 'package:minimart/utils/exceptions/firebaseauth_exception.dart';
import 'package:minimart/utils/exceptions/format_exception.dart';
  ...
  screenRedirect() async {
    ...
    if (user != null) {
      if (user.emailVerified) {
        ...
        Get.offAll(() => VerificationEmailScreen(
